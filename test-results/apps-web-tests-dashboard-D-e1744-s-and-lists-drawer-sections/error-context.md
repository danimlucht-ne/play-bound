...
- Name: apps\web\tests\dashboard.spec.js >> Dashboard smoke tests >> Admin drawer opens for eligible admins and lists drawer sections
- Location: apps\web\tests\dashboard.spec.js:119:3
