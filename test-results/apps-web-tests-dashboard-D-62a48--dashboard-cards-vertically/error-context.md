...
- Name: apps\web\tests\dashboard.spec.js >> Dashboard smoke tests >> Mobile viewport stacks dashboard cards vertically
- Location: apps\web\tests\dashboard.spec.js:132:3
