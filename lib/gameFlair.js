...
const FLAIR = {
    ...
    mastermind: {
        titles: ['🎯 Mastermind!', '🔐 Crack the code!', 'Black peg, white peg, no mercy.'],
        lines: [
            'One code. All eyes on the board. First exact match takes the crown.',
            'Your deducing skills: online. The secret pattern: not.',
            'It’s not guessing—it’s a polite interrogation of digits.',
        ],
    },
    moviequotes: {
