...
const ACHIEVEMENTS = {
    ...
    CODEBREAKER: { name: 'Codebreaker', desc: 'Win a Mastermind in under 2 minutes from game start.', emoji: '⏱️' },
    MASTERMIND_ROOKIE: { name: 'Mastermind Rookie', desc: 'Win 1 Mastermind game.', emoji: '🎯' },
    MASTERMIND_STREAKER: { name: 'Mastermind Streaker', desc: 'Win 3 Mastermind games.', emoji: '🎯' },
    MASTERMIND_CRYPTANALYST: { name: 'Cryptanalyst', desc: 'Win 5 Mastermind games.', emoji: '🔐' },
    MASTERMIND_LEGEND: { name: 'Mastermind Legend', desc: 'Win 15 Mastermind games.', emoji: '🎯' },
    MASTERMIND_MYTHIC: { name: 'Mastermind Mythic', desc: 'Win 30 Mastermind games.', emoji: '🧠' },
};
...
const STAT_ACHIEVEMENT_MILESTONES = {
    ...
    mastermindWins: { thresholds: [1, 3, 5, 15, 30], keys: ['MASTERMIND_ROOKIE', 'MASTERMIND_STREAKER', 'MASTERMIND_CRYPTANALYST', 'MASTERMIND_LEGEND', 'MASTERMIND_MYTHIC'] },
